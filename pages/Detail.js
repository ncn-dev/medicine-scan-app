      ...
      <View style={{ paddingHorizontal: 50, marginTop: 80 }}>
        ...
        <View style={{ paddingHorizontal: 20, marginVertical: 20 }}>
          ...
          <View style={{ flexDirection: "row", justifyContent: "space-around" }}>
            <TouchableOpacity
              style={{
                backgroundColor: mealTime === "before" ? "#4CAF50" : "#E0E0E0",
                padding: 10,
                borderRadius: 10,
              }}
              onPress={() => setMealTime("before")}
            >
              <Text style={{ color: mealTime === "before" ? "#fff" : "#000" }}>
                ก่อนอาหาร
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              style={{
                backgroundColor: mealTime === "after" ? "#4CAF50" : "#E0E0E0",
                padding: 10,
                borderRadius: 10,
              }}
              onPress={() => setMealTime("after")}
            >
              <Text style={{ color: mealTime === "after" ? "#fff" : "#000" }}>
                หลังอาหาร
              </Text>
            </TouchableOpacity>
          </View>
